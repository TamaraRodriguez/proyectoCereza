...
<div>
	...
	<table>
		<!-- recoger los datos del cliente en la tabla personas -->
	...
	<form action="#" method="POST">
		...
		<table>
			<tr>
				...
				<td><label for="ncliente"><spring:message code='numerocliente'/> </label></td><!--  Número de cliente:-->
				<td><input type="text" id="ncliente" name="ncliente" placeholder="Recuperar número de cliente de los albaranes" disabled /></td>
